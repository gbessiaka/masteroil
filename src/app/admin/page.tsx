...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-black text-brand-cream mb-1">Tableau de bord</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
        {stats.map((stat, i) => (
          <div key={i} className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
            ...
            <p className="text-brand-cream text-3xl font-black">{stat.value}</p>
          </div>
        ))}
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800">
              <h2 className="text-brand-cream font-bold">Commandes récentes</h2>
              <Link
                    ...
                    >
                      <td className="px-6 py-4">
                        <Link
                          ...
                          className="text-brand-cream text-sm font-medium hover:text-brand-gold transition-colors"
                        >
                      ...
                      <td className="px-6 py-4 text-brand-gold text-sm font-semibold">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-brand-cream font-bold">Stock faible</h2>
              </div>
              <Link
                href="/admin/stocks"
                className="text-brand-gold text-sm hover:text-brand-gold-light transition-colors"
            ...
            <div className="p-4 space-y-3">
              {lowStock.map((item) => (
                ...
                >
                  <div>
                    <p className="text-brand-cream text-sm font-medium leading-tight">
                      {item.product_name}
                    </p>
