  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-black text-brand-cream mb-1">Commandes</h1>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {statuses.map((s) => {
          ...
          return (
            <div
              key={s.value}
              className="bg-zinc-800 border border-zinc-700 px-4 py-2 rounded-full text-sm text-zinc-300 flex items-center gap-2"
            >
              {s.label}
              ...
              {orders.map((order) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    ...
                    {order.client?.phone && (
                      <p className="text-zinc-500 text-xs mt-0.5">{order.client.phone}</p>
                    )}
                  </td>
                  <td className="px-6 py-4 text-zinc-400 text-sm">
