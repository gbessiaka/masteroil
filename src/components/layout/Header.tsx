...
export function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile menu — EN DEHORS du header pour éviter le backdrop-filter stacking context */}
      <div className={cn(
        'lg:hidden fixed inset-0 z-50 transition-opacity duration-300',
        isMobileMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
      )}>
        <div className="absolute inset-0 bg-black/75" onClick={() => setIsMobileMenuOpen(false)} />
        <div className={cn(
